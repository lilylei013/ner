...
//    String serializedClassifier = "classifiers/english.all.3class.distsim.crf.ser.gz";
    String serializedClassifier = "classifiers/mytestfull_model.ser.gz";
...
//    	 String[] example = {"LUCKIN COFFEE Receives Formal Delisting Notice From Nasdaq. Shares Resume Plunge"};
//    	 String[] example = {"mynew test1 company is my new fake company, when client have new company need to pay attention to, they can use manual way to add model datasource"};
    	 String[] example = {"mynew test1 company"};
...
//            Double newValue = cl.get(CoreAnnotations.AnswerProbAnnotation.class);
//			String position = cl.get(CoreAnnotations.PositionAnnotation.class);
//			String category = cl.get(CoreAnnotations.AnswerAnnotation.class);
//			System.out.println("newValue: " + newValue +  "category: " + category +  " position:" + position);
//          }
//        }
//      }
